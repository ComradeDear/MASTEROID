...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/27429a8aa60255b15f77e.jpg"
else:
...
CUSTOM_MIDDLE_PMP = str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "**YOU ARE IN MY MASTER'S INBOX** \n THIS IS ILLEGAL AND REGARDED AS A CRIME" 

USER_BOT_WARN_ZERO = "`YOU ARE SPAMMING MY SWEET MASTER'S PM AND HENCE YOU ARE BLOCKED.`\n**Now GTFO, i'm busy**"
USER_BOT_NO_WARN = ("`Hello, I AM A POWERFULL ASSISTANT ...YOU FOUND YOUR WAY HERE. ,`"
                   f"{DEFAULTUSER}'s inbox. HE IZ BUSY RIGHT NOW...REGISTER YOUR COMPLAINT HERE AND HE WILL REPLY YOU WHEN HE WILL COME BACK ONLINE\n"
                   f"\n**{CUSTOM_MIDDLE_PMP}**\n\n"
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        chat = await event.get_chat()
        if event.is_private:
          if chat.id == 1990239830 or chat.id == 1884903792:
